...
## 8. Geometry fix (2026-07-13)

**X marks must be vertically even:** top half of each X equals bottom half (mirror about horizontal center line).
Masters regenerated with symmetric `>` / `<` chevrons so upper arms match lower arms.
Do not use older exports where X looked top-heavy or uneven.
