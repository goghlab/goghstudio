...
const exampleImages = [
  {
    url: "/images/floating1.jpg",
    author: "Gogh Studio",
    title: "Classical Bust on Books",
  },
  {
    url: "/images/floating2.jpg",
    author: "Gogh Studio",
    title: "Minimalist Product",
  },
  {
    url: "/images/floating3.jpg",
    author: "Gogh Studio",
  ...
  return (
    <section className="w-full h-screen overflow-hidden md:overflow-visible flex flex-col items-center justify-center relative bg-[#030303]">
      ...
      <div className="flex flex-col justify-center items-center w-[250px] sm:w-[300px] md:w-[500px] lg:w-[700px] z-50 pointer-events-auto">
        ...
        <motion.p
          className="text-sm sm:text-base md:text-xl lg:text-2xl text-center pt-4 sm:pt-6 md:pt-8 lg:pt-10 text-white/60 font-sans"
          animate={{ opacity: 1, y: 0 }}
          initial={{ opacity: 0, y: 20 }}
        ...
        <motion.p
          className="text-sm sm:text-base md:text-xl lg:text-2xl text-center pt-2 sm:pt-4 md:pt-6 lg:pt-8 text-white/80 font-sans"
          animate={{ opacity: 1, y: 0 }}
          initial={{ opacity: 0, y: 20 }}
        ...
        <div className="flex flex-row justify-center space-x-4 items-center mt-6 sm:mt-10 md:mt-14 lg:mt-16 text-xs">
          <motion.button
            className="sm:text-base md:text-lg lg:text-xl font-semibold tracking-tight text-background bg-foreground px-6 py-3 sm:px-8 sm:py-3 md:px-10 md:py-4 lg:px-12 lg:py-4 rounded-xl z-20 shadow-2xl font-sans"
            animate={{ opacity: 1, y: 0 }}
            initial={{ opacity: 0, y: 20 }}
            transition={{
              duration: 0.2,
          ...
          <motion.button
            className="sm:text-base md:text-lg lg:text-xl font-semibold tracking-tight text-white bg-gradient-to-b from-blue-600 to-blue-800 px-6 py-3 sm:px-8 sm:py-3 md:px-10 md:py-4 lg:px-12 lg:py-4 rounded-xl z-20 shadow-2xl font-sans border border-white/10 hover:from-blue-500 hover:to-blue-700 transition-all"
            animate={{ opacity: 1, y: 0 }}
            initial={{ opacity: 0, y: 20 }}
            transition={{
              duration: 0.2,
