...
import 定價Section from "../components/pricing-section"
            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
                  ...
                  <div className="self-stretch flex-1 flex justify-start items-start">
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <div className="relative w-full h-full overflow-hidden">
                        {/* 產品 Image 1 - Plan your schedules */}
                        <div
                        ...
                        >
                          <img
                            src="/ai-studio-hero-1.png"
                            alt="Schedules Dashboard - Customer Subscription Management"
                            className="w-full h-full object-cover"
                          />
                        </div>

                        {/* 產品 Image 2 - Data to insights */}
                        <div
                          className={`absolute inset-0 transition-all duration-500 ease-in-out ${
                        ...
                        >
                          <img
                            src="/ai-ad-production.png"
                            alt="Analytics Dashboard"
                            className="w-full h-full object-cover"
                          />
                        </div>

                        {/* 產品 Image 3 - Data visualization */}
                        <div
                          className={`absolute inset-0 transition-all duration-500 ease-in-out ${
              ...
              <div className="self-stretch border-t border-[#E0DEDB] border-b border-[#E0DEDB] flex justify-center items-start">
                ...
                <div className="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  ...
                  <FeatureCard
                    title="專業網站"
                    description="10-20頁企業官網，設計精美，交付快速。"
                  ...
                  <FeatureCard
                    title="AI 圖片"
                    description="產品圖、宣傳圖，一站式生成，告別昂貴攝影。"
              ...
              <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
                ...
                <div className="self-stretch border-[rgba(55,50,47,0.12)] flex justify-center items-start border-t border-b-0">
                  ...
                  <div className="flex-1 grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 gap-0 border-l border-r border-[rgba(55,50,47,0.12)]">
                    {/* Logo Grid - AI Services */}
                    {[
                      { icon: "/ai-brain-icon.png", name: "AI 圖片生成" },
                      { icon: "/ai-video-icon.png", name: "AI 影片製作" },
                      { icon: "/ai-cloud-icon.png", name: "雲端部署" },
                      { icon: "/ai-robot-icon.png", name: "智能客服" },
                      { icon: "/ai-brain-icon.png", name: "SEO 優化" },
                      { icon: "/ai-video-icon.png", name: "社群營銷" },
                      { icon: "/ai-cloud-icon.png", name: "網站開發" },
                      { icon: "/ai-robot-icon.png", name: "數據分析" },
                    ].map((item, index) => {
                      ...
                      return (
                        <div
                          ...
                          `}
                        >
                          <div className="w-10 h-10 xs:w-11 xs:h-11 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 relative shadow-[0px_-4px_8px_rgba(255,255,255,0.64)_inset] overflow-hidden rounded-full bg-[#F7F5F3] flex items-center justify-center">
                            <img src={item.icon} alt={item.name} className="w-8 h-8 xs:w-9 xs:h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 object-contain" />
                          </div>
                          <div className="text-center flex justify-center flex-col text-[#37322F] text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-tight font-sans px-1">
                            {item.name}
                          </div>
                        </div>
                      )
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-0 border-l border-r border-[rgba(55,50,47,0.12)]">
                    ...
                    <div className="border-b border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          快速、低價、高質量 — 用 AI 為你做到傳統agency 幾倍嘅效果。
                        </p>
                      </div>
                    ...
                    <div className="border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6 bg-transparent">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          告別多個供應商，一個團隊幫你做曬：網站、廣告、圖片、SEO、機械人。
                        </p>
                      </div>
