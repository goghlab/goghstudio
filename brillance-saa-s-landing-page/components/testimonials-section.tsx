...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    {
      quote:
        "Gogh AI Studio has revolutionized how we handle custom contracts. The automation saves us hours every week and eliminates errors completely.",
      name: "Sarah Chen",
    ...
    {
      quote:
        "帳單自動化是遊戲規則改變者。過去團隊需要數天完成的工作，現在自動精準完成。",
      name: "李明遠",
      company: "財務總監，創新企業",
